...
[![NPM](https://img.shields.io/npm/v/sf-i-select.svg)](https://www.npmjs.com/package/sf-i-select) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)
...
- **Header & Footer** - SfISelect component generates both the header and footer view
...
- **Search Input** - SfISelect ships with a search input field
- **Social Media** - SfISelect accepts social media links as an un-ordered list and renders them into the footer
- **Copyright Notice** - SfISelect accepts copyright notice as input and renders it into the footer
...
- **Call-to-action Button** - SfISelect comes with a call-to-action button, which can be used to highlight key actions such as sign in and subscribe.
...
- **Customizability** - SfISelect colors can be customized using css custom properties
- **Responsiveness** - SfISelect nicely adapts to all screen sizes
...
<html>
  <head>
    ...
    <title>&lt;sf-i-select&gt; Demo</title>
    <!-- Integration material icons as they are used in sf-i-select -->
    ...
    <!-- Integration lit and sf-i-select web components module -->
    <script type="module">
        import {LitElement, html, css} from 'https://unpkg.com/lit-element/lit-element.js?module';
        import {SfISelect} from 'https://unpkg.com/sf-i-select/sf-i-select.js?module';
    </script>
    <style>
  ...
  <body style="margin: 0px;">
    ...
    <script>
      document.getElementsByTagName('sf-i-select')[0].addEventListener('searchClick', () => {console.log('hurray');})
      document.getElementsByTagName('sf-i-select')[0].addEventListener('routeChange', (e) => {
...
Search Input is shown by default and the SfISelect component throws a searchClick event after the user types something in the search input field and presses enter. To handle the searchClick event:

```html

    <script>
      document.getElementsByTagName('sf-i-select')[0].addEventListener('searchClick', () => {console.log('search clicked');})
    </script>
